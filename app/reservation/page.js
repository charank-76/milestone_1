...
return(
    ...
    <div className="bg-white dark:bg-stone-900 w-full min-h-screen flex flex-col md:items-center  ">
      <Navbar/>
    ...
    <h3>/Contact</h3>
      ...
      <section className="w-[800px]  border-2 border-gray-500  mb-10 flex flex-col bg-white items-center p-4   gap-10">
        ...
        <form className="flex flex-col gap-6 w-[70%]">
          <input type="text" placeholder="Your Name*" className="border border-gray-400 px-4 py-3  text-black rounded-md"/>
          <input type="email" placeholder="Your Email*" className="border border-gray-400 px-4 py-3  text-black rounded-md"/>
          <input type="text" placeholder="Subject*" className="border border-gray-400 px-4 py-3  text-black rounded-md"/>
          <textarea placeholder="Your Message*" className="border border-gray-400 px-4 py-3  text-black rounded-md h-32"></textarea>
          <button type="submit" className="bg-red-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-black ">Send Message</button>
        </form>
      </section>
