...
export default function LMenuCard({imgurl,name,desc,sugg,price}) {
    return (
            ...
            <div className="flex md:flex-row flex-col border border-gray-300 bg-white p-2 rounded-lg shadow-md  ">
                ...
                <img
                    ...
                    <div className="text-3xl pr-2 font-bold text-black mt-10 p-1 md:ml-15">${price}</div>
            </div>
